...
-- at runtime using the environment variable image_viewer_bindir.
...
-- environment variable image_viewer_libdir.
...
-- using the environment variable image_viewer_dynlibdir.
...
-- runtime using the environment variable image_viewer_datadir.
...
-- variable image_viewer_libexedir.
...
-- using the environment variable image_viewer_sysconfdir.
...
bindir     = "/home/lulz/.cabal/bin"
libdir     = "/home/lulz/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/image-viewer-0.1.0.0-inplace-image-viewer"
dynlibdir  = "/home/lulz/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/lulz/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/image-viewer-0.1.0.0"
libexecdir = "/home/lulz/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/image-viewer-0.1.0.0"
sysconfdir = "/home/lulz/.cabal/etc"

getBinDir     = catchIO (getEnv "image_viewer_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "image_viewer_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "image_viewer_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "image_viewer_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "image_viewer_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "image_viewer_sysconfdir") (\_ -> return sysconfdir)
