...
/* package image-viewer-0.1.0.0 */
#ifndef VERSION_image_viewer
#define VERSION_image_viewer "0.1.0.0"
#endif /* VERSION_image_viewer */
#ifndef MIN_VERSION_image_viewer
#define MIN_VERSION_image_viewer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_image_viewer */
...
/* package gi-gtk-4.0.12 */
#ifndef VERSION_gi_gtk
#define VERSION_gi_gtk "4.0.12"
...
#define CURRENT_COMPONENT_ID "image-viewer-0.1.0.0-inplace-image-viewer"
